...
2. **Consultation:** Read [doc/contracts/LIST_ADDON_THEORY.md](../../doc/contracts/LIST_ADDON_THEORY.md) and [doc/status/LIST_IMPLEMENTATION_STATUS.md](../../doc/status/LIST_IMPLEMENTATION_STATUS.md) for the matching Velocity `action` / `list_id`.
