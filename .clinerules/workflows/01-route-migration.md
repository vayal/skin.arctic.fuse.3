...
2. **Consultation:** Read [doc/context/LIST_ADDON_THEORY.md](../../doc/context/LIST_ADDON_THEORY.md) and [doc/roadmap/LIST_IMPLEMENTATION_STATUS.md](../../doc/roadmap/LIST_IMPLEMENTATION_STATUS.md) for the matching Velocity `action` / `list_id`.
