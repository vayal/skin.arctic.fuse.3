...
Derived from `doc/skin-vision-blueprint-v0.md` and repo inventory. This file is the **target**, **status**, and **open work** index — not a changelog.
...
- [ ] Document canonical `list_id` / action per genre in `doc/d015-…` or appendix
...
- [ ] **Dedicated addon work** doc; link from `doc/` index or this file
