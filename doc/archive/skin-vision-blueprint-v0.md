...
| D-003 | Home/Hubs | Keep all hub widget modes (`standard/combined/wall`) | Multiple modes coexist | Hardcode one primary mode for personal fork | P1 | accept | locked via `../target/d003-view-mode-matrix.md` with case-by-case decisions and no fallback mode switching |
