...
| D-038 | Contracts | Remaining legacy property-model references | Deprecated but present in places | Retire where possible; leave documented exceptions only | P1 | accept | locked via `doc/d038-legacy-property-ledger.md` with batch-based decisions and explicit deferred exceptions |
