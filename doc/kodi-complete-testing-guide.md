...
**Purpose:** Step-by-step manual QA in **Kodi** to verify the skin against the roadmap ([README.md](roadmap/README.md)), close **Phase 07** runtime gaps, and confirm addon/list behavior against [D-015](d015-addon-required-lists-contract.md) and [screen-by-screen-build-contract.md](screen-by-screen-build-contract.md).
...
- Code-backed hub wiring: [kodi-ui-verification-matrix.md](roadmap/kodi-ui-verification-matrix.md)
- Phase 03 bootstrap + runtime evidence table: [phase-03-validation-report.md](roadmap/phase-03-validation-report.md)
- Phase 07 stabilization criteria: [phase-07-validation-report.md](roadmap/phase-07-validation-report.md)
- Checklist buckets: [appendix-verification-checklists.md](roadmap/appendix-verification-checklists.md)
- Legacy/helper policy: [doc/d038-legacy-property-ledger.md](d038-legacy-property-ledger.md)
...
- [phase-03-validation-report.md](roadmap/phase-03-validation-report.md) — §“Runtime evidence (operator capture)” table (items: Home, Series 1101, Movies 1102, provider drill-in).
- [phase-07-validation-report.md](roadmap/phase-07-validation-report.md) — update §2 runtime columns and §1 overall outcome when all gates pass.
...
**Option A — focused reset (from [phase-03-validation-report.md](roadmap/phase-03-validation-report.md))**
...
| 2 | Open Series (1101) and Movies (1102) | Rows load from `plugin://plugin.video.velocity2/...` per [kodi-ui-verification-matrix.md](roadmap/kodi-ui-verification-matrix.md) §4. |
| 3 | **Optional (addon contract):** For any paginated row, open “full list” or next page if the UI exposes it | Response matches [D-015](d015-addon-required-lists-contract.md): pagination fields where applicable; terminal page has no spurious next step (verify in log or addon debug if available). |
...
Follow [kodi-ui-verification-matrix.md](roadmap/kodi-ui-verification-matrix.md) **§2–§4** in order.
...
**Note:** Core Kodi PVR windows may still exist at the Kodi level; Phase 04 removed **skin XML** in scope per [phase-04-validation-report.md](roadmap/phase-04-validation-report.md).
...
| 4 | Trailer | If used: play trailer from item; windows **1122/1123** behave per [phase-05-validation-report.md](roadmap/phase-05-validation-report.md). |
...
#### D. Pagination and empty states ([appendix-verification-checklists.md](roadmap/appendix-verification-checklists.md) §3)
...
When all Phase 07 criteria are met, update [README.md](roadmap/README.md) Phase 07 row and [phase-07-validation-report.md](roadmap/phase-07-validation-report.md) per that document.

---

## 5. Master checklist (appendix verification — full pass)

Use this as a **single-session** or **release** gate. Items reference [appendix-verification-checklists.md](roadmap/appendix-verification-checklists.md).
...
See [kodi-ui-verification-matrix.md](roadmap/kodi-ui-verification-matrix.md) **§5**: contract row names vs generator rows, optional library search tabs, and “mini-hub” wording differences. Log discrepancies in your test notes for product/addon backlog.
...
| Resource | Role |
|----------|------|
| [roadmap/README.md](roadmap/README.md) | Phase status and playbooks |
| [appendix-traceability-matrix.md](roadmap/appendix-traceability-matrix.md) | D-003 / D-015 / D-021 / D-038 mapping |
| [skin-vision-blueprint-v0.md](skin-vision-blueprint-v0.md) | Product vision |
| [screen-by-screen-build-contract.md](screen-by-screen-build-contract.md) | Target UX + list contracts |
