...
**Topic spine:** [traceability-by-topic.md](../traceability-by-topic.md) — maps non-list scopes (`search-discovery`, `details-context`, `osd-playback`, …) to roadmap specs, context, and QA.
...
| List as-built status | [./LIST_IMPLEMENTATION_STATUS.md](./LIST_IMPLEMENTATION_STATUS.md) |
...
| Document | Contents |
|----------|----------|
| [./nonlist-osd-playback-status.md](./nonlist-osd-playback-status.md) | OSD windows 1140 / 1141 / 1143, pause overlay, `Custom_1193` |
| [./nonlist-pvr-removal-status.md](./nonlist-pvr-removal-status.md) | PVR entry points and includes |
| [./nonlist-submenu-shortcut-editor-status.md](./nonlist-submenu-shortcut-editor-status.md) | Home submenu strip, `ActivateWindow(1115)` |
| [./nonlist-details-context-status.md](./nonlist-details-context-status.md) | D-021 context menu, details lean pass, D-038 grep |
| [./nonlist-nextaired-home-status.md](./nonlist-nextaired-home-status.md) | NextAired on Home policy |
