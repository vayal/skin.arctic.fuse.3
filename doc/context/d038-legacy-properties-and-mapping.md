...
Single **`doc/context/`** reference for **D-038** (file-level ledger, batches, exceptions, completion) and the **TMDbHelper → native/Velocity mapping table**. Open helper/property backlog: [phase-02 plan](../roadmap/phase-05-debt-cleanup-and-policy-closure.md).
...
- [phase-05-debt-cleanup-and-policy-closure.md](../roadmap/phase-05-debt-cleanup-and-policy-closure.md)
