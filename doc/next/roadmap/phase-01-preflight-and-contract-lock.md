...
- [x] No conflicting docs outside `doc/next/roadmap/` required for execution

## File-Level Touch List

- docs only:
  - `doc/next/roadmap/*` (this package)
  - optional traceability updates in `doc/next/roadmap/appendix-traceability-matrix.md`
...
- roadmap package creation under `doc/next/roadmap/`
- decision lock confirmation in:
  - `doc/archive/skin-vision-blueprint-v0.md`
  - `doc/target/d003-view-mode-matrix.md`
  - `doc/target/d015-addon-required-lists-contract.md`
  - `doc/reference/d038-legacy-property-ledger.md`
