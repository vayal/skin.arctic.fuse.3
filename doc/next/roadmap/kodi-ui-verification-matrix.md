...
**Full pass:** For a single end-to-end testing guide (bootstrap, journeys, Phase 07 closure), see [Kodi complete manual testing guide](../../velocity/kodi-complete-testing-guide.md).
...
| **Inventory / traceability** | [inventory/01-home-and-hubs.md](../../velocity/surfaces/01-home-and-hubs.md), [appendix-traceability-matrix.md](./appendix-traceability-matrix.md) | Structural IDs (`HomeSwitcher.*`, hub windows) |
